...
Map<String, dynamic> _$UserArrayToJson(UserArray instance) =>
    <String, dynamic>{};

PetPetIdPost$RequestBody _$PetPetIdPost$RequestBodyFromJson(
...
Map<String, dynamic> _$PetPetIdPost$RequestBodyToJson(
        PetPetIdPost$RequestBody instance) =>
    <String, dynamic>{
      'name': instance.name,
